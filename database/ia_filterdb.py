...
class Media(Document):
    ...
    file_ref = fields.StrField(required=True, default=None)
    file_name = fields.StrField(required=True, default=None)
...
async def get_search_results(chat_id, query, file_type=None, max_results=6, offset=0, filter=False):
